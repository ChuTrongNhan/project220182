  ...
  <div>
    ...
    <div class="row info-page-row">
        <div class="row">
          ...
          <div class="value">{{student.student_phone}}</div>
    ...
    <div class="row info-page-row">
        <div class="row">
          <div class="field">Khoa</div>
          <div class="value">{{student.student_major}}</div>
        </div>
    </div>
    ...
    <div class="row info-page-row">
        <div class="row">
          <div class="field">Trạng thái</div>
          <div class="value">{{student.student_status}}</div>
        </div>
    </div>
  ...
  methods: {
    ...
    updatePhone: async function(str) {
      try {
        this.phone = '';
        this.loadingInfoPage = true;
        let response = await axios.put('/students/' + this.user.id, {phone: str});
